...
public class SimplePlayEngine {
    ...
    func initComponent(type: String, subType: String, manufacturer: String, completion: @escaping (Result<Bool, Error>, ViewController?) -> Void) {
        ...
        // Instantiate the audio unit.  Here we pass loadInProcess, but in this version of the project
        // we expect it to fail over to loading out-of-process, since this project is not set up for
        // running in-process.
