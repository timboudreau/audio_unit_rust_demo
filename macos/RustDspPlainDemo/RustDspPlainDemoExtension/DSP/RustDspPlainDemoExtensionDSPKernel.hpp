...
#import "RustDspPlainDemoExtension-Swift.h"
 ...
 */
class RustDspPlainDemoExtensionDSPKernel {
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case RustDspPlainDemoExtensionParameterAddress::gain:
                write_f32_atomic(&params.gain, value);
                break;
            case RustDspPlainDemoExtensionParameterAddress::pan:
