...
#include <vector>
#include "RustDspPlainDemoExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(RustDspPlainDemoExtensionDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    RustDspPlainDemoExtensionDSPKernel& mKernel;
