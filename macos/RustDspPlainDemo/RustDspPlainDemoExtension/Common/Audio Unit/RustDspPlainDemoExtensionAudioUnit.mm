...
#import "RustDspPlainDemoExtensionBufferedAudioBus.hpp"
#import "RustDspPlainDemoExtensionAUProcessHelper.hpp"
#import "RustDspPlainDemoExtensionDSPKernel.hpp"
#import "mock_dsp_lib.h"

@interface RustDspPlainDemoExtensionAudioUnit ()
...
@implementation RustDspPlainDemoExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    RustDspPlainDemoExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block RustDspPlainDemoExtensionDSPKernel *kernel = &_kernel;
