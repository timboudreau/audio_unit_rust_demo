...
private let log = Logger(subsystem: "com.mastfrog.RustDspPlainDemoExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: RustDspPlainDemoExtensionAudioUnit?
    
    var hostingController: HostingController<RustDspPlainDemoExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try RustDspPlainDemoExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit else {
            log.error("Unable to create RustDspPlainDemoExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(RustDspPlainDemoExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: RustDspPlainDemoExtensionAudioUnit) {
        ...
        let content = RustDspPlainDemoExtensionMainView(parameterTree: observableParameterTree, audioUnit : audioUnit)
