...
#include <vector>
#include "RustDspInProcessDemoExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(RustDspInProcessDemoExtensionDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    RustDspInProcessDemoExtensionDSPKernel& mKernel;
