...
import os
import SwiftUI
//import RustDspInProcessFramework_Private

private let log = Logger(subsystem: "com.mastfrog.RustDspInProcessDemoExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: RustDspInProcessDemoExtensionAudioUnit?
    
    var hostingController: HostingController<RustDspInProcessDemoExtensionMainView>?
	...
	*/
    ...
    public required init?(coder: NSCoder) {
        fatalError("Init from coder supported")
    }
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try RustDspInProcessDemoExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit else {
            log.error("Unable to create RustDspInProcessDemoExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(RustDspInProcessDemoExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: RustDspInProcessDemoExtensionAudioUnit) {
        ...
        let content = RustDspInProcessDemoExtensionMainView(parameterTree: observableParameterTree, audioUnit: audioUnit)
